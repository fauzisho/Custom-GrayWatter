package com.graywater.customgraywater.custom;
 ...
 * @param <MT> the type of the model type ({@code Class<T>} for example)
 */
public abstract class MultiListAdapter<T, VH extends RecyclerView.ViewHolder, MT> extends RecyclerView.Adapter<VH> {
    ...
    /**
     * @param viewHolderCreator the view holder creator to register.
     * @param viewHolderClass   the class of the viewholder.
     */
     ...
     * @param parts     the binders to use to display this model.
     * @param listener  the listener to associate with the model.
     */
     ...
     *
     * @param viewHolderPosition the position of the view holder in the adapter.
    ...
    /**
     * @param viewType the internal viewtype.
     ...
     *
     * @param lastBoundViewHolderPosition the position of the last viewholder that was bound.
     * @param direction                   the direction the list is moving.
     */
     ...
     *
     * @param viewHolderPosition the position of the viewholder.
     * @param binder             the binder to call.
     * @param model              the model being prepared.
     * @param binderList         the list of binders
     * @param binderIndex        the index in the list of viewholders associated with this model
     */
     ...
     *
     * @param itemPosition model item position.
     ...
     *
     * @param viewHolderPosition viewholder position
     ...
     *
     * @param itemPosition the position in the list of items.
    ...
    /**
     * @param item   the item to add to the adapter.
     * @param notify whether or not to notify the adapter.
     */
     ...
     *
     * @param viewHolderPosition the position in the view holder.
    ...
    /**
     * @param itemIndex          the current view holders binder position.
     ...
     *
     * @param position the position to insert into the list.
     * @param item     the item to add. Note that if it is <code>null</code>, there is no way to determine which binder to use.
     */
     ...
     * Note that this is an <i>O(n)</i> operation, since the cache needs to be updated.
     *
     * @param itemPosition removes the item at the position from the adapter.
     ...
     *
     * @param itemPosition the item position that was updated.
     ...
     *
     * @param itemPosition    the position for the item that uses the view holder.
     * @param viewHolderClass the view holder type to look for.
    ...
    public interface Binder<U, V extends RecyclerView.ViewHolder> {
         ...
         *
         * @param model       the model that will be bound.
         * @param binderList  the list of binders.
         * @param binderIndex the index of the binder in the list of binders.
         */
        void prepare(@NonNull U model, List<Binder<? super U, ? extends V>> binderList, int binderIndex);

        /**
         * Called when {@link RecyclerView.Adapter#onBindViewHolder(RecyclerView.ViewHolder,
         * int)}
         * is called.
         *
         * @param model          the model to bind to the viewholder
        ...
        /**
         * Called when {@link RecyclerView.Adapter#onViewRecycled(RecyclerView.ViewHolder)}
         * is called.
         *
         * @param holder the view holder that was recycled.
         */
    ...
    public interface ViewHolderCreator {
        /**
         * Called when {@link RecyclerView.Adapter#onCreateViewHolder(ViewGroup, int)}
         * is called.
         *
         ...
         *
         * @return the view type to associate with this {@link RecyclerView.ViewHolder}.
         */
        int getViewType();
    }
    ...
    public interface ActionListener<U, V extends RecyclerView.ViewHolder> {
        /**
         * @param model       the model associated with the view that was modified.
         * @param holder      the viewholder associated with the view that was touched.
         * @param v           the view that was touched.
         * @param binderList  the list of binders associated with the model.
         * @param binderIndex the index of the binder that was modified.
         * @param obj         an extra object for message passing.
         */
    ...
    /**
     * A helper {@link View.OnClickListener} that can be used to hold references to objects that are
    ...
    public static class ActionListenerDelegate<U, V extends RecyclerView.ViewHolder>
        ...
        /**
         * @param actionListener the listener to call on click.
         * @param model          the model that is being clicked.
         * @param holder         the view holder that is being clicked.
         * @param binders        the list of binders associated with the model.
         * @param binderIndex    the index into the list of binders of the view holder that is being clicked.
         * @param obj            an extra object that can be used to pass around extra data.
         */
    ...
    final class BinderResult {
         ...
         * @param itemPosition the position of the model in the list of models.
         * @param binderList   the list of binders associated with the item.
         * @param binderIndex  the index of the specific binder to use in the {@code binderList}.
         */
